...
فرض شد ممکن است در برخی خطوط لاگ خراب یا تلاش‌های نفوذ، کاراکتر جفت‌کوتیشن (`"`) درون Query String یا در هدرهای دیگر وجود داشته باشد. اول از متد ساده `split('"')` یا پیدا کردن اولین و دومین کاراکتر کوتیشن باعث می‌شد بخش Request به اشتباه استخراج شود و مقدار Status Code و بایت ارسالی جابجا شده یا غیرقابل‌پارس تشخیص داده شوند.
